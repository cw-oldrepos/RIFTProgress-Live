<?php
    ...
    function generate_external_hyperlink($url, $target, $class) {
        $hyperlink = "";
        ...
        if ( $url != "" ) {
            if ( $target == 0 ) {
                $hyperlink = "<a class='$class' href='$url' target='_self'>$url</a>";
            } else if ( $target == 1 ) {
                $hyperlink = "<a class='$class' href='$url' target='_blank'>$url</a>";
            }
        } else {
            $hyperlink = "<a class='$class'>$url</a>";
        }
    ...
    function generate_table_fields($guild_details, $text_limit) {
        ...
        if ( strlen($guild_details['website']) == 0 )  { $guild_details['website'] = "N/A"; } else { $guild_details['website'] = generate_external_hyperlink($guild_details['website'], 1, ""); }
